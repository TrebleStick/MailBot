...
if("TRUE" STREQUAL "TRUE")
  set(openni_launch_SOURCE_PREFIX /home/human/Documents/catkin_ws/src/openni_camera/openni_launch)
  set(openni_launch_DEVEL_PREFIX /home/human/Documents/catkin_ws/devel)
  ...
  set(openni_launch_INSTALL_PREFIX /home/human/Documents/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://www.ros.org/wiki/openni_launch " STREQUAL " ")
    set(_report "Check the website 'http://www.ros.org/wiki/openni_launch' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/human/Documents/catkin_ws/src/openni_camera/openni_launch/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${openni_launch_dep}_FOUND)
      find_package(${openni_launch_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${openni_launch_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
